...
if __name__ == "__main__":
    start_time = time.time()
    filenames = ['erdos_renyi-d-u-homo-down', 'erdos_renyi-d-u-hetero-down']
    print(filenames)
    count = 1
    stress, sigma, x, du, us, dD, Ds = init_conditions(1, 1)
    x_equis, var, u_crit, C_ensemble = equilibrium(sigma, stress, x, k, du, 1)
